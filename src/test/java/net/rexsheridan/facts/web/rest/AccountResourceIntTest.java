package net.rexsheridan.facts.web.rest;

import net.rexsheridan.facts.config.Constants;
import net.rexsheridan.facts.FactsApp;
import net.rexsheridan.facts.domain.Authority;
import net.rexsheridan.facts.domain.User;
import net.rexsheridan.facts.repository.AuthorityRepository;
import net.rexsheridan.facts.repository.UserRepository;
import net.rexsheridan.facts.security.AuthoritiesConstants;
import net.rexsheridan.facts.service.MailService;
import net.rexsheridan.facts.service.dto.UserDTO;
import net.rexsheridan.facts.web.rest.errors.ExceptionTranslator;
import net.rexsheridan.facts.web.rest.vm.KeyAndPasswordVM;
import net.rexsheridan.facts.web.rest.vm.ManagedUserVM;
import net.rexsheridan.facts.service.UserService;
...
@SpringBootTest(classes = FactsApp.class)
