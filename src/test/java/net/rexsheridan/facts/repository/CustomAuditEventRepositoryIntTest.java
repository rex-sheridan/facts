package net.rexsheridan.facts.repository;

import net.rexsheridan.facts.FactsApp;
import net.rexsheridan.facts.config.Constants;
import net.rexsheridan.facts.config.audit.AuditEventConverter;
import net.rexsheridan.facts.domain.PersistentAuditEvent;
...
import static net.rexsheridan.facts.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
